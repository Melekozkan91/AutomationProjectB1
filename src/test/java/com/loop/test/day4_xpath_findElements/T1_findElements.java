...
public class T1_findElements {
    public static void main(String[] args) {
        ...
        System.out.println("nbaLinks = "+nbaLinksXpath.size());

        for (WebElement nbaLink : nbaLinks) {
            if (!nbaLink.getText().equals(" ")) {
                System.out.println("nbaLink = " + nbaLink);
                System.out.println("nbaLink.getAttribute = " + nbaLink.getAttribute("href"));
        ...
        for (int i = 0; i < nbaLinks.size(); i++) {
            if (!nbaLinks.get(i).getText().equals("")) {
                ...
                System.out.println("nbaLink.getAttribute = " + nbaLinks.get(i).getAttribute("href"));
